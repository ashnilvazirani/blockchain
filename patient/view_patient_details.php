...
<td class="text-left"><?php echo $patient_first_name." ".$patient_last_name;?></td>
</tr>

<tr>
<td class="text-left">Phone number</td>
<td class="text-left"><?php echo $patient_phone;?></td>
</tr>

<tr>
<td class="text-left">Blood group</td>
<td class="text-left"><?php echo $patient_blood_group;?></td>
</tr>

<tr>
<td class="text-left">Age</td>
<td class="text-left"><?php echo $patient_age;;?></td>
</tr>

<tr>
<td class="text-left">Organ Submitted</td>
<td class="text-left"><?php echo $patient_organ;?></td>
</tr>
    
<tr onclick="openIdentity()">
<td class="text-left">Identity Document</td>
<td class="text-left"><?php echo $patient_identity;?></td>
</tr>

<tr onclick="openReports()">
<td class="text-left">Medical Reports</td>
<td class="text-left"><?php echo $patient_medical_document;?></td>
</tr>

<tr>
<td class="text-left">Status</td>
<td class="text-left"><?php echo $patient_status;?></td>
</tr>
    
        <?php
    if($patient_status!=0){
        $query="SELECT * FROM patient_hospital WHERE patient_id=$patient_id";    
        $data=mysqli_query($con, $query);
        $hospital_name="";
//        print_r($data);
...
<td class="text-left">		<a href="../login.php?logout=1" style="color: red;">logout</a>
    ...
    <script>
        function openIdentity() {
            window.open("http://localhost/blockchain/patient/view_document.php?var=1&value=<?php echo $patient_identity;?>");   
        }
        function openReports() {
            window.open("http://localhost/blockchain/patient/view_document.php?var=2&value=<?php echo $patient_medical_document;?>");   
        }
      </script>
</html>