...
if(isset($_GET['doc_id']) and $_GET['app']==1){
    $id=$_GET['doc_id'];
    $query_update_doctor = "UPDATE dcotor SET doctor_status = 1 WHERE doctor_id = $id";
							...
							<table border='5'>
								...
								<?php while ($row = mysqli_fetch_array($results)) { ?>
									<tr>
                                        ...
                                        <td><button class="editbtn"><a href="approve_doctor.php?app=1&doc_id=<?php echo $row['doctor_id'];?>">Approve</a></button></td>
									</tr>
								<?php } ?>
							</table>
